...
namespace RedmiNote7ToolC
{
    public partial class DownloadMIUIeu : Form
    {
        ...
        public void checkfiles()
        {
            ...
            string fileName = @"C:\adb\xiaomieu\xiaomi.eu_multi_HMNote7_20.1.9_v11-10.zip";
        ...
        private void DownloadMIUIeu_Load(object sender, EventArgs e)
        {
            ...
            string[] paths = Directory.GetFiles(@"C:\adb\xiaomieu\", "xiaomi.eu_multi_HMNote7_20.1.9_v11-10.zip");
            if (paths.Length > 0)
            {
                checkfiles();
            }
        ...
        public void startDownload()
        {
            if (!this.IsDisposed)
            {
                Thread thread = new Thread(() =>
                {
                    ...
                    client.DownloadFileAsync(new Uri("https://va2.androidfilehost.com/dl/AcYtGQPwGo9Z_1ceLo8-SQ/1579099528/4349826312261698111/xiaomi.eu_multi_HMNote7_20.1.9_v11-10.zip"), @"C:\adb\xiaomieu\xiaomi.eu_multi_HMNote7_20.1.9_v11-10.zip");
                });
                thread.Start();
            }
            else
